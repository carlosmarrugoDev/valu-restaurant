...
export const productos: Producto[] = [
  ...
  { id: 'p4', nombre: 'Tacos al pastor', precio: 165, categoria: 'fuertes', imagen: '/images/tacos-pastor.png', descripcion: 'Orden de 4, piña, cebolla y cilantro' },
  { id: 'p5', nombre: 'Ribeye 400g', precio: 480, categoria: 'fuertes', imagen: '/images/ribeye.png', descripcion: 'Corte premium con guarnición' },
  { id: 'p6', nombre: 'Enchiladas de mole', precio: 210, categoria: 'fuertes', imagen: '/images/enchiladas.png', descripcion: 'Mole poblano de la casa, pollo' },
  { id: 'p7', nombre: 'Agua de horchata', precio: 55, categoria: 'bebidas', imagen: '/images/horchata.png', descripcion: 'Jarra de arroz con canela' },
  { id: 'p8', nombre: 'Margarita clásica', precio: 135, categoria: 'bebidas', imagen: '/images/margarita.png', descripcion: 'Tequila, limón y sal de gusano' },
  { id: 'p9', nombre: 'Cerveza artesanal', precio: 85, categoria: 'bebidas', imagen: '/images/cerveza.png', descripcion: 'IPA local 355ml' },
  { id: 'p10', nombre: 'Flan de la casa', precio: 95, categoria: 'postres', imagen: '/images/flan.png', descripcion: 'Napolitano con caramelo' },
  { id: 'p11', nombre: 'Churros con cajeta', precio: 90, categoria: 'postres', imagen: '/images/churros.png', descripcion: 'Orden de 5 con cajeta quemada' },
  { id: 'p12', nombre: 'Pastel de elote', precio: 105, categoria: 'postres', imagen: '/images/pastel-elote.png', descripcion: 'Con helado de vainilla' },
]
